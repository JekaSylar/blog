...
import { _ as _sfc_main$1, a as _sfc_main$4 } from "./DialogModal-DLAENE0H.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./InputError-CFENxfoo.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Браузерні сесії `);
          } else {
            return [
              createTextVNode(" Браузерні сесії ")
            ];
          }
        }),
        description: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Керуйте активними сесіями в інших браузерах і пристроях та виходьте з них. `);
          } else {
            return [
              createTextVNode(" Керуйте активними сесіями в інших браузерах і пристроях та виходьте з них. ")
            ];
          }
        }),
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-w-xl text-sm text-gray-600 dark:text-gray-400"${_scopeId}> Якщо необхідно, ви можете вийти з усіх інших сеансів браузера на всіх ваших пристроях. Деякі з ваших останніх сесій наведені нижче; однак цей список може бути неповним. Якщо ви вважаєте, що ваш обліковий запис було скомпрометовано, вам також слід оновити свій пароль. </div>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, { onClick: confirmLogout }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Вийдіть з інших сеансів браузера `);
                } else {
                  return [
                    createTextVNode(" Вийдіть з інших сеансів браузера ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Будь ласка, введіть пароль, щоб підтвердити, що ви хочете вийти з інших сеансів браузера на всіх ваших пристроях. <div class="mt-4"${_scopeId2}>`);
                  ...
                  return [
                    createTextVNode(" Будь ласка, введіть пароль, щоб підтвердити, що ви хочете вийти з інших сеансів браузера на всіх ваших пристроях. "),
              ...
              footer: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$2, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` Вийдіть з інших сеансів браузера `);
                      } else {
                        return [
                          createTextVNode(" Вийдіть з інших сеансів браузера ")
                        ];
            ...
            return [
              createVNode("div", { class: "max-w-xl text-sm text-gray-600 dark:text-gray-400" }, " Якщо необхідно, ви можете вийти з усіх інших сеансів браузера на всіх ваших пристроях. Деякі з ваших останніх сесій наведені нижче; однак цей список може бути неповним. Якщо ви вважаєте, що ваш обліковий запис було скомпрометовано, вам також слід оновити свій пароль. "),
