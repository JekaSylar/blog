...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Увійти" }, null, _parent));
      _push(ssrRenderComponent(AuthenticationCard, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="ms-2 text-sm text-gray-600 dark:text-gray-400"${_scopeId}>Запам&#39;ятати ?</span></label></div><div class="flex items-center justify-end mt-4"${_scopeId}>`);
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "block mt-4" }, [
                  createVNode("label", { class: "flex items-center" }, [
                    ...
                    createVNode("span", { class: "ms-2 text-sm text-gray-600 dark:text-gray-400" }, "Запам'ятати ?")
                  ])
                ]),
