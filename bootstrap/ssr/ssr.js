...
import { computed, ref, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, Transition, openBlock, createBlock, withModifiers, createCommentVNode, useSSRContext, createSSRApp, h as h$1 } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
import { Menu, MenuButton, TransitionRoot, Dialog, TransitionChild, DialogPanel } from "@headlessui/vue";
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8" }, _attrs))}><button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden"><span class="sr-only">Open sidebar</span>`);
      _push(ssrRenderComponent(unref(Bars3Icon), {
        class: "h-6 w-6",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</button><div class="h-6 w-px bg-gray-900/10 lg:hidden" aria-hidden="true"></div><div class="w-full flex justify-end flex-1 gap-x-4 self-stretch lg:gap-x-6"><div class="flex items-center gap-x-4 lg:gap-x-6">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(MenuButton), {
              class: "-m-1.5 flex items-center justify-end p-1.5",
              onClick: ($event) => openMenu.value = !openMenu.value
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="sr-only"${_scopeId2}>Open user menu</span><span class="hidden lg:flex lg:items-center"${_scopeId2}><span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true"${_scopeId2}>${ssrInterpolate(user.value.name)}</span>`);
                  ...
                  return [
                    ...
                    createVNode("span", { class: "hidden lg:flex lg:items-center" }, [
                      createVNode("span", {
                        ...
                        "aria-hidden": "true"
                      }, toDisplayString(user.value.name), 1),
            ...
            _push2(``);
            if (openMenu.value) {
              _push2(`<ul class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"${_scopeId}><li${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("profile.show"),
                class: [_ctx.route().current("profile") ? "bg-gray-50" : "", "block px-3 py-1 text-sm leading-6 text-gray-900"]
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Профиль `);
              ...
              _push2(`<a class="${ssrRenderClass([[_ctx.route().current("logout") ? "bg-gray-50" : "", "block px-3 py-1 text-sm leading-6 text-gray-900"], "cursor-pointer"])}"${_scopeId}>Вихід</a></li></ul>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  openMenu.value ? (openBlock(), createBlock("ul", {
                    key: 0,
                    ...
                    createVNode("li", null, [
                      ...
                      createVNode("a", {
                        ...
                        class: ["cursor-pointer", [_ctx.route().current("logout") ? "bg-gray-50" : "", "block px-3 py-1 text-sm leading-6 text-gray-900"]]
                      }, "Вихід", 2)
                    ])
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="flex h-16 shrink-0 items-center justify-center font-bold text-white text-center"> Адмінка </div><nav class="flex flex-1 flex-col"><ul role="list" class="flex flex-1 flex-col gap-y-7"><li><ul role="list" class="-mx-2 space-y-1"><li>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home"),
        class: "block rounded-md py-2 pl-10 pr-2 text-sm font-semibold leading-6 text-white"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Головна`);
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        class: "block rounded-md bg-gray-50 py-2 pl-10 pr-2 text-sm font-semibold leading-6 text-black"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Адмінка`);
            ...
            return [
              createTextVNode("Адмінка")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><li><div><button type="button" class="flex w-full items-center gap-x-3 rounded-md p-2 text-left text-sm font-semibold leading-6 text-white hover:bg-gray-50 hover:text-black" aria-controls="sub-menu-1" aria-expanded="false"><svg class="${ssrRenderClass([{ "rotate-90": openMenu.value }, "h-5 w-5 shrink-0 text-gray-400"])}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd"></path></svg> Блог </button>`);
      if (openMenu.value) {
        _push(`<ul class="mt-1 px-2" id="sub-menu-1"><li><a href="#" class="block rounded-md py-2 pl-9 pr-2 text-sm leading-6 text-gray-700 hover:bg-gray-50">Записи</a></li><li>`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("categories.index"),
          class: "block rounded-md py-2 pl-9 pr-2 text-sm leading-6 text-white hover:bg-gray-50 hover:text-black"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Категорії`);
        ...
        _push(`</li><li><a href="#" class="block rounded-md py-2 pl-9 pr-2 text-sm leading-6 text-gray-700 hover:bg-gray-50">Customer Success</a></li></ul>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></li></ul></li></ul></nav><!--]-->`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/NavMenu.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
                        ...
                        _push4(ssrRenderComponent(unref(DialogPanel), { class: "relative mr-16 flex w-full max-w-xs flex-1" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10"${_scopeId4}>`);
                              ...
                              return [
                                ...
                                createVNode("div", { class: "flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10" }, [
      ...
      _push(`<div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col"><div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">`);
      _push(ssrRenderComponent(_sfc_main$1, null, null, _parent));
      _push(`</div></div><div class="lg:pl-72">`);
      _push(ssrRenderComponent(_sfc_main$2, { onOpenSidebar: handleOpenSidebar }, null, _parent));
      _push(`<main class="py-10"><div class="px-4 sm:px-6 lg:px-8">`);
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Admin/Category/Partials/CreateCategoryForm.vue": () => import("./assets/CreateCategoryForm-CrOL0sUM.js"), "./Pages/Admin/Category/Partials/ListCategories.vue": () => import("./assets/ListCategories-o5ijcwu9.js"), "./Pages/Admin/Category/Show.vue": () => import("./assets/Show-BHtpdYpi.js"), "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-BEWO5-m0.js"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-Bve1V-8a.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-C5gD2cnU.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-BLYgT5UI.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-D4yFiO46.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-BGevku6R.js"), "./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge-OnPgjY5L.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-DcE98nSl.js"), "./Pages/PrivacyPolicy.vue": () => import("./assets/PrivacyPolicy-BvilYZOp.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-lFx4ShoZ.js"), "./Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": () => import("./assets/LogoutOtherBrowserSessionsForm-CyGLKhbN.js"), "./Pages/Profile/Partials/TwoFactorAuthenticationForm.vue": () => import("./assets/TwoFactorAuthenticationForm-CJY8g4Oq.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-Do_XHNyk.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-Blg7-b8Z.js"), "./Pages/Profile/Show.vue": () => import("./assets/Show-C3tAzmmJ.js"), "./Pages/TermsOfService.vue": () => import("./assets/TermsOfService-ealoVoJf.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-fw4BC0B8.js") })).then((module) => {
